...
if(isset($_GET['ref'])) {
	switch (e($_GET['ref'])) {
		case 'tambah':
			# code...
			$sql = "insert into tr_jenis_surat_keluar (jenis, keterangan, status, id_rekam) values('$_POST[jenis_surat]', '$_POST[keterangan]', '$_POST[status]', '".getAuth()['id_user']."')";
		...
		case 'edit':
			...
			$sql .= " where id_jenis_surat_keluar = '".$_POST['oldIdJenis']."'";
