...
if(!isset($_GET['token'])) {
    redirect("index.php?page=jenis_surat_masuk");
} else {
  $id = buka(htmlspecialchars(e($_GET['token'])));
   $data = execSelectQuery("select * from tr_jenis_surat_masuk where id_jenis_surat_masuk = $id limit 0,1");
    $row = array_shift($data);
?>
<div class="container-fluid">
  <h2>Edit Jenis Surat masuk<hr></h2>

  <ul class="breadcrumb">
    <li><a href="#">Home</a></li>
    <li> <a href="?page=jenis_surat_masuk">Jenis Surat masuk</a></li>
    <li>Edit Jenis Surat masuk</li>
  </ul>

  <p>&nbsp;</p>
  <h4>Silahkan mengubah data pada form berikut</h4>
  <p>&nbsp;</p>
  <form class="form-horizontal" role="form" action="?page=simpan_jenis_surat_masuk&ref=edit" method="post">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-3 col-sm-10">
        <input type="hidden" name="oldIdJenis" style="display: none;" value="<?= $row['id_jenis_surat_masuk']?>">
